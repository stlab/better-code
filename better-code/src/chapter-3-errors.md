...
- Reasoning:
  ...
  - Expense of conditional branches up the call chain
  - Cascade of throws and try or complex Result types.
  - Helps reasoning about bugs when they occur by classifying more
    things as bugs.  If every use of a function is legal it becomes
    hard to point a finger at anything.
